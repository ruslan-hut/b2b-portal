...
1. **Local Development** (Recommended): Use `environment.local.ts` for your personal dev settings:
   ...
   ```
   See [Frontend Local Development](../getting-started/frontend-local-development.md) for details.
...
3. **Production**: Set the `API_URL` environment variable or GitHub secret (see [Frontend Build and Deployment](../development/frontend-build-deployment.md))
...
Please refer to [Frontend Coding Policy](../development/frontend-coding-policy.md) for detailed coding guidelines including:
...
For comprehensive frontend documentation, see the [Documentation Index](../README.md):

- **[Quick Start Guide](../getting-started/frontend-quickstart.md)** - Fast setup and testing
- **[Coding Policy](../development/frontend-coding-policy.md)** - Coding standards and conventions
- **[API Documentation](../api/frontend-integration.md)** - Frontend API integration guide
- **[Translation Implementation](../development/translation-implementation.md)** - Complete translation system
- **[Translation Quick Start](../development/translation-quick-start.md)** - Quick translation setup
- **[Deployment Guide](../development/frontend-build-deployment.md)** - Frontend deployment instructions
- **[Frontend Design Policy](../development/frontend-design-policy.md)** - Frontend design system

For project-wide documentation, see the [Main Documentation Index](../README.md).
...
Please follow the coding standards outlined in [Frontend Coding Policy](../development/frontend-coding-policy.md).
