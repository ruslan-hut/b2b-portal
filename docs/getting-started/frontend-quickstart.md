...
See [Frontend Local Development](./frontend-local-development.md) for detailed instructions.
...
See [API Documentation](../api/frontend-integration.md) for details.
...
For detailed coding guidelines, see [Frontend Coding Policy](../development/frontend-coding-policy.md)

For documentation overview, see [Documentation Index](../README.md)

For project overview, see [Frontend Overview](../architecture/frontend-overview.md)
